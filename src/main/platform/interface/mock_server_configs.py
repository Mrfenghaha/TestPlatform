...
class DBQuery:
    ...
    def db_query(self):
        ...
        resp_status_list = [resp_status.value for resp_status in database_func("mock_configs", "get", "all_value_by_parm", "resp_status")]  # 响应状态列表
...
class Func(DBQuery):
    ...
    def get_mock_configs(self):
        ...
        data = {"methods": methods_list, "resp_status": resp_status_list, "replace_param": replace_param_info}
        return data
